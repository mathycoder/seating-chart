Rails.application.routes.draw do
  ...
  patch '/klasses/:klass_id/students/dynamic_pairs_hetero', to: 'students#dynamic_pairs_hetero'
  patch '/klasses/:klass_id/students/dynamic_pairs_homo', to: 'students#dynamic_pairs_homo'
